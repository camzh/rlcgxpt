...
const DEMAND_SOURCE_TYPE_OPTIONS = [
  { label: "公司需求", value: "company" },
  { label: "我的需求", value: "own" },
  { label: "共享给我", value: "shared" }
];
...
Page({
  data: {
    ...
    sourceTypeOptions: DEMAND_SOURCE_TYPE_OPTIONS
  },
  ...
  onLoad(query) {
    ...
    this.setData({
      ...
      sourceTypeLabel: getOptionLabel(this.data.sourceTypeOptions, form.sourceType, "我的需求"),
      form: {
        ...form,
