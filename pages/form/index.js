...
const CATEGORY_SPECS = {
  ...
  "整机服务器": [
    ...
    { key: "nic", label: "网卡1", placeholder: "例如：2*100GbE" },
    { key: "nic2", label: "网卡2", placeholder: "例如：100G双光口" },
    { key: "nic3", label: "网卡3", placeholder: "例如：IB 200G" },
    { key: "nic4", label: "网卡4", placeholder: "例如：OCP 25G" },
    { key: "extraNics", label: "更多网卡", placeholder: "例如：25G*2 / 100G*4" },
    { key: "pcieSwitch", label: "PCIE交换芯片", placeholder: "例如：Broadcom PEX 系列" }
  ],
  "CPU": [
...
function buildSpecDetails(form) {
  ...
  return {
    ...
    nic2: existing.nic2 || form.nic2 || "",
    nic3: existing.nic3 || form.nic3 || "",
    nic4: existing.nic4 || form.nic4 || "",
    extraNics: existing.extraNics || form.extraNics || "",
    pcieSwitch: existing.pcieSwitch || form.pcieSwitch || "",
...
function syncLegacySpecFields(form) {
  ...
  return {
    ...
    nic2: spec.nic2 || form.nic2 || "",
    nic3: spec.nic3 || form.nic3 || "",
    nic4: spec.nic4 || form.nic4 || "",
    extraNics: spec.extraNics || form.extraNics || ""
  };
}
